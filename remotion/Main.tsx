  ...
  dialog: [
    {
      ...
      instructions:
        "voice: breathy youth; emotional range: anxious to hopeful; intonation: rising at the end; speed: slightly quick; tone: earnest, vulnerable",
      side: "left",
      voice: "onyx",
    },
    {
      ...
      instructions:
        "warm, low, steady; emotional range: calm, compassionate; intonation: even; speed: slow; tone: reassuring",
      side: "right",
      voice: "ash",
    },
    {
      ...
      instructions:
        "soft, fragile; emotional range: fearful to curious; intonation: pleading; speed: moderate; tone: small and open",
      side: "left",
      voice: "onyx",
    },
    {
      ...
      instructions:
        "metaphoric, steady; emotional range: patient wisdom; intonation: rising then softening; speed: measured; tone: vivid and calm",
      side: "right",
      voice: "ash",
    },
    {
      ...
      instructions:
        "rushed, honest; emotional range: frustrated; intonation: clipped; speed: quick; tone: candid",
      side: "left",
      voice: "onyx",
    },
    {
      ...
      instructions:
        "gentle, instructional; emotional range: encouraging; intonation: calm crescendos on key phrases; speed: slow; tone: guiding",
      side: "right",
      voice: "ash",
    },
    {
      ...
      instructions:
        "hesitant then a little lighter; emotional range: doubtful to tentative hope; intonation: falling then hopeful; speed: moderate; tone: soft",
      side: "left",
      voice: "onyx",
    },
    {
      ...
      instructions:
        "warm, resonant; emotional range: confident compassion; intonation: emphatic on 'small' and 'listen'; speed: slow; tone: nurturing",
      side: "right",
      voice: "ash",
    },
    {
      ...
      instructions:
        "quiet resolve; emotional range: resolved, calm; intonation: steady uplift at the end; speed: moderate; tone: sincere",
      side: "left",
      voice: "onyx",
    },
    {
      ...
      instructions:
        "soft command, inviting; emotional range: warm encouragement; intonation: gentle crescendo toward CTA; speed: slow; tone: hopeful, present; whispering at the final phrase for intimacy",
      side: "right",
      voice: "ash",
    },
  ],
