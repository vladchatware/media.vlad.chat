...
export const Tweet = ({
  ...
  return (
    <CameraMotionBlur shutterAngle={280} samples={1}>
      <AbsoluteFill>
        <AbsoluteFill
          style={{ ...styles.container, backgroundColor: _theme.fill }}
        >
          <div
            style={{ ...styles.content, backgroundColor: _theme.background }}
          >
            <div style={styles.innerContaner}>
              <header style={styles.header}>
                ...
                />
                <div>
                  <p style={{ ...styles.headerTitle, color: _theme.color }}>
                    {username}
                  </p>
                  <p style={{ ...styles.handle, color: "rgb(85, 99, 111)" }}>
                    {handle}
                  </p>
                </div>
              </header>
